                 ...
                 <ul class="nav nav-list">
                    ...
                    <li class="">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="">
                                <a href="#">
                                    <i class="menu-icon fa fa-caret-right"></i> SolicitaÁıes
                                </a>
                                        ...
                                        <div>
                                            <ul class="steps">
                                                ...
                                                <li data-step="3">
                                                    ...
                                                    <span class="title">Informa√ß√µes de pagamento</span>
                                                </li>

                                                <li data-step="4">
                                                    <span class="step">4</span>
                                                    <span class="title">Confirma√ß√£o</span>
                                                </li>
                                            </ul>
                                        </div>
                                                    ...
                                                    <div class="row col-lg-12">
                                                        <div>
                                                            ...
                                                            <select class="chosen-select form-control" id="selectPagamento"
                                                                ...
                                                                <option value="1">Cart√£o de credito</option>
                                        ...
                                        <div class="step-pane" data-step="4">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <label for="number-button" class="block">N√∫mero </label>
                                                    <input class="form-control" type="text"
        ...
        <script type="text/javascript">
                            ...
                            $.ajax({
                                ...
                                success: function (result) {
                                    if(result=="erroPerfil"){
                                        alert("Perfil de usu·rio n„o condiz com a aÁ„o solicitada!                              -----[Perfil n„o È comprador]-----")
                                    }else{
                    ...
                    function adicionarCarrinho(nome, id, valor)
                    {
                        ...
                        if (quantCompr == 0) {
                            ...
                            alert("Quantidade em estoque: " + quantProd + ". Favor incluir valor menor ou igual ao dÌsponivel! ")
                            document.getElementById("quantiaCompra" + id).value = "";
                            ...
                            posicaoCarrinho += 1;
                            document.getElementById("quantiaCompra" + id).placeholder = "Qtd disponÌvel: "+resultCompr;
